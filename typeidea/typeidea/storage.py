...
class WatermarkStorage(FileSystemStorage):
    def save(self, name, content, max_length=None):
        if 'images' in content.content_type:
            # 加水印
            image = self.watermark_with_text(content, 'java-Lee-chan.com', 'red')
    ...
    def water_with_text(self, file_obj, text, color, fontfamily=None):
